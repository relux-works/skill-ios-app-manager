...
## Notes
agent spawned: claude (pid=56468, exit=0)
Implemented in internal/ioc/register.go — init() registers IoC module, SetupFromRegistry adapts to local Setup, stub Plan and usageGuide. Build+vet+tests pass.
